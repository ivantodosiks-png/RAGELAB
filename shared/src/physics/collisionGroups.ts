...
export const WORLD_GROUPS = groups(Group.World, Group.World | Group.Prop | Group.Player | Group.Door);
export const PROP_GROUPS = groups(Group.Prop, Group.World | Group.Prop | Group.Player | Group.Door);
export const PLAYER_GROUPS = groups(Group.Player, Group.World | Group.Prop | Group.Door);
export const DOOR_GROUPS = groups(Group.Door, Group.World | Group.Prop | Group.Player);
