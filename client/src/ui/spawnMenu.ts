...
export class SpawnMenu {
  ...
  constructor(host: HTMLElement) {
    ...
    titles.append(el('div', 'spawn-title', 'SPAWN MENU'), el('div', 'spawn-sub', 'Tool Gun · select an object'));
  ...
  private renderGrid(): void {
    const entries = entriesFor(this.category).filter((entry) => matchesQuery(entry, this.query));
